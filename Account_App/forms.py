...
class VerificationForm(forms.ModelForm):
     ...
     application = forms.CharField(required=True,label="Body",widget=forms.TextInput(attrs={'rows':10, 'cols':30, 'value':'Hello, I am writing an application to verfy my given information to AreHare.', 'style':'margin:15px 0;', 'class': 'form-control'}))
